...
class _ChooseNewLeaderScreenState extends State<ChooseNewLeaderScreen> {
  ...
  void initState() {
    super.initState();
    _eligibleMembers = widget.team.teamMembers
                ...
                : DropdownButtonFormField<TeamMember>(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(8.0),
                        borderSide: BorderSide(color: widget.colors.itemBgColor, width: 2.0),
                      ),
                    ),
                    items: _eligibleMembers.map((member) {
              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    ...
                    child: Text('Cancel', style: TextStyle(color: widget.colors.textColor)),
                  ),
                  ...
                  ElevatedButton(
                    onPressed: _selectedNewLeader == null
                        ? null 
                        : () {
                            Navigator.of(context).pop(_selectedNewLeader!.userId);
                          },
